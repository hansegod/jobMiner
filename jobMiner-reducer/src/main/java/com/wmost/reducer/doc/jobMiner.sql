...
CREATE TABLE `position` (
	...
	`time_stamp` 	varchar(64) 	DEFAULT '' COMMENT '日志时间戳',
	`log_type` 		varchar(64) 	DEFAULT '' COMMENT '日志类型',
	`search_key` 	varchar(64) 	DEFAULT '' COMMENT '日志唯一标识[0-9A-Za-z]{32}',
	`time_ms` 		varchar(64) 	DEFAULT '' COMMENT '处理耗时(ms)',
	...
	`count` 			varchar(64) 	DEFAULT '' COMMENT '数量',
	`type` 				varchar(64) 	DEFAULT '' COMMENT '类型',
	`pubtime` 			varchar(64) 	DEFAULT '' COMMENT '发布',
	`offtime` 			varchar(64) 	DEFAULT '' COMMENT '截止',
	`salary` 			varchar(64) 	DEFAULT '' COMMENT '薪资',
...
CREATE TABLE `candidate` (
	...
	`expect_nature` 	varchar(64) 	DEFAULT '' COMMENT '性质*',
	`expect_position` 	varchar(64) 	DEFAULT '' COMMENT '职位*',
	`expect_type` 		varchar(64) 	DEFAULT '' COMMENT '类型*',
	`expect_salary` 	varchar(64) 	DEFAULT '' COMMENT '薪资*',
